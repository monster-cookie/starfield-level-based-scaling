  ...
  While (menuActive)
    If (message == DS_ConfigMenuMain)
      ...
      ElseIf (menuButtonClicked == 1)
        ;; CLICKED 1: Show Enabled Features Menu
      ...
      ElseIf (menuButtonClicked == 5)
        ;; CLICKED 5: Enable Debug Mode
        VPI_Debug.DebugMessage("ConfigTerminal", "ProcessMenu", "Main Menu Button 5 clicked Enable Debug Mode.", 0, Venpi_DebugEnabled.GetValueInt())
        Venpi_DebugEnabled.SetValueInt(1)
      ElseIf (menuButtonClicked == 6)
        ;; CLICKED 6: Disable Debug Mode
        VPI_Debug.DebugMessage("ConfigTerminal", "ProcessMenu", "Main Menu Button 6 clicked Disable Debug Mode.", 0, Venpi_DebugEnabled.GetValueInt())
