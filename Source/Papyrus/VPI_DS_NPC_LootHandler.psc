...
Event OnEffectStart(ObjectReference akTarget, Actor akCaster, MagicEffect akBaseEffect, Float afMagnitude, Float afDuration)
  ...
  Else 
    ...
    If (Myself.HasKeyword(NPC_Varuun))
      HandleLootVaruun(VPI_Helper.GetNPCVersion(akTarget, NPC_Type_MK5, NPC_Type_MK4, NPC_Type_MK3, NPC_Type_MK2, NPC_Type_MK1))
    ElseIf (Myself.HasKeyword(NPC_Pirate))
      HandleLootPirate(VPI_Helper.GetNPCVersion(akTarget, NPC_Type_MK5, NPC_Type_MK4, NPC_Type_MK3, NPC_Type_MK2, NPC_Type_MK1))
    Else
      HandleLootGeneric(VPI_Helper.GetNPCVersion(akTarget, NPC_Type_MK5, NPC_Type_MK4, NPC_Type_MK3, NPC_Type_MK2, NPC_Type_MK1))
    EndIf
  EndIf
EndEvent
...
Function HandleLootGeneric(Int npcType)
  If (npcType == 5)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootGeneric", "Generic Leveled NPC is a MK5 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
  ...
  ElseIf (npcType == 4)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootGeneric", "Generic Leveled NPC is a MK4 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    If (Utility.RandomInt(1,25) > 15)
      Myself.AddItem(LL_Loot_Legendary_Human as Form, 1, true)
    EndIf
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 3)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootGeneric", "Generic Leveled NPC is a MK3 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 2)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootGeneric", "Generic Leveled NPC is a MK2 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 1)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootGeneric", "Generic Leveled NPC is a MK1 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  EndIf
EndFunction
...
Function HandleLootPirate(Int npcType)
  If (npcType == 5)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootPirate", "Pirate Leveled NPC is a MK5 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    Myself.AddItem(LL_Contraband_Any as Form, Utility.RandomInt(4,10), true)
    Myself.AddItem(LL_Loot_Legendary_Human as Form, 1, true)
    Myself.AddItem(LL_Loot_Misc as Form, 3, true)
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 4)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootPirate", "Pirate Leveled NPC is a MK4 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    ...
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 3)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootPirate", "Pirate Leveled NPC is a MK3 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    Myself.AddItem(LL_Contraband_Any as Form, Utility.RandomInt(1,4), true)
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 2)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootPirate", "Pirate Leveled NPC is a MK2 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    Myself.AddItem(LL_Contraband_Any as Form, Utility.RandomInt(1,2), true)
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 1)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootPirate", "Pirate Leveled NPC is a MK1 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  EndIf
EndFunction
...
Function HandleLootVaruun(Int npcType)
  If (npcType == 5)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootVaruun", "Va'ruun Leveled NPC is a MK5 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    ...
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 4)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootVaruun", "Va'ruun Leveled NPC is a MK4 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    ...
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 3)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootVaruun", "Va'ruun Leveled NPC is a MK3 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    ...
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 2)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootVaruun", "Va'ruun Leveled NPC is a MK2 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
    ...
    Myself.AddItem(LL_Loot_Digipick as Form, 1, true)
  ElseIf (npcType == 1)
    VPI_Helper.DebugMessage("NPCLootHandler", "HandleLootVaruun", "Va'ruun Leveled NPC is a MK1 class and needs loot updated.", 0, DSDebugMode.GetValueInt())
