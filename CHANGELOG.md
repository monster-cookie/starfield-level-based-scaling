...
* The infinate scaling NPCs (lst in tree) have unique names for example spaces is Spacer Legend and Ecliptic is Ecliptic Commander
...
* Fixed a typo in the math formula that adjusts damage for armor resistance making it 3 times stong then it should have been 
* NOTE: I still need to tune the scae factors for the new high level NPCs. 
